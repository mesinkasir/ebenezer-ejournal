...
{% fullimage "https://images.unsplash.com/photo-1498050108023-c5249f4df085", "Desk" %}
...
{% sidenote "01", "Typography", "Lihat buku Robert Bringhurst" %}
Penggunaan font serif sangat penting untuk keterbacaan artikel panjang.
{% endsidenote %}
...
Ini adalah paragraf normal. {% notes "n1", "Ini adalah catatan di pinggir tanpa nomor." %}
